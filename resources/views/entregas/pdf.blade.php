    ...
    <div
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
            ...
            <tbody>
                ...
                <tr>
                    <td style="padding: 8px; border-bottom: 1px solid #ddd;">CALLE AYACUCHO, CENTRO 
                        DE PUNTA DE MATA</td>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
            <thead>
                <tr>
                    ...
                    <th style="padding: 8px; text-align: left;">Banco de Destino</th>
                    <th style="padding: 8px; text-align: left;">Referencia</th>
                    <th style="padding: 8px; text-align: left;">Moneda</th>
                    <th style="padding: 8px; text-align: left;">Total Pagado</th>
                </tr>
            </thead>
            <tbody>
        ...
        <div style="display: flex; justify-content: space-between; margin-top: 20px; align-items: flex-start;">
            ...
            <div
                ...
                <!-- Después de la sección de totales y antes del cierre del body -->
                <div style="text-align: center; margin-top: 20px;">

                    ________________________________
                    <p style="margin-bottom: 0;">Firma del Cliente:</p>
                    <div style="border-top: 1px solid #ddd; margin-top: 10px; padding-top: 5px;">
                        <!-- Aquí puedes agregar campos para la firma, nombre del cliente, etc. -->
                    </div>
                </div>
            </div>
