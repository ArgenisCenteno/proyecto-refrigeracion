                        ...
                        <div>
                            <form action="{{route('pagarCuenta')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <label for="banco_origen" class="form-label"><strong>Banco de
                                                Origen</strong></label>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="banco_destino" class="form-label"><strong>Banco de
                                    ...
                                    <div class="col-md-6">
                                        <label for="numero_referencia" class="form-label"><strong>Número de
                                ...
                                <div class="mb-3">
                                    <label for="comprobante" class="form-label"> <strong>Recibo de Transferencia / Pago
                                            móvil</strong> </label>
